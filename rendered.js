function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const products = [
    { name: 'SEND TARGET INFO SYSTEM', price: 25, add: false, dayPrice: false },
    ...
    { name: 'COSTUME, MOUNT, PET, TIME EXTENSION SYSTEM', price: 25, add: false, dayPrice: false },
    ...
    { name: 'CHARACTER TITLE SYSTEM', price: 25, add: false, dayPrice: false },
